		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>shadowdemon_xd CHECKER</strong></h4>
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/shadowdemon_xd"> CONTACT TO BUY NONSK</a> <br>
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CC HERE :>"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/hackingcourseuz"> JOIN MY CHANNEL 😀 </a> <br>		
...
<h5>LIMIT :<span class="badge badge-secondary float-right">1K LANG PO</span></h5>
...
Swal.fire({ title: "@shadowdemon_xd", text: "HOPE U LIKED TUTORIAL", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
